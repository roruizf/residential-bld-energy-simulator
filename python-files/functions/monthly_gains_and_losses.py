...
def solar_gains():
    ...
    """
    Q_solar_sec_i_m = np.zeros(12)
    return Q_solar_sec_i_m


def solar_gains_heating():
    Q_solar_heat_sec_i_m = solar_gains()
    return Q_solar_heat_sec_i_m


def solar_gains_overheating():
    Q_solar_overh_sec_i_m = solar_gains()
    return Q_solar_overh_sec_i_m


def solar_gains_cooling():
    Q_solar_cool_sec_i_m = solar_gains()
    return Q_solar_cool_sec_i_m
...
def internal_gains_overheating(V_sec_i: float, t_m: list) -> list:
